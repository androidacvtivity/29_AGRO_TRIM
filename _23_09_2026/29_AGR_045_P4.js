...
// --------------------------------------------------------------
// Transformă separatorul zecimal din virgulă în punct
// Exemplu: 12,5 -> 12.5
// Funcționează și la tastare, și la Paste
// --------------------------------------------------------------
function normalizeDecimalComma() {

    var selector = 'input.numeric, input.float';
    ...
    jQuery(document)
        ...
        .on('keydown.decimalComma', selector, function (event) {
            ...
            if (event.key === ',' || event.keyCode === 188) {
                ...
                // Nu permitem al doilea separator zecimal.
                if (value.indexOf('.') !== -1) {
                    return;
                }
    ...
    // Pentru valori introduse prin Paste:
    // 12,5 -> 12.5
    jQuery(document)
